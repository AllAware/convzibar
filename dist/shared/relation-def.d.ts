 ...
 */
export declare function classifyStringRef(raw: string, ctx: ClassificationContext): RelationTargetShape;
/**
...
}, objectType: string, seed: ReadonlyArray<string>, options?: ExpandOptions): string[];
