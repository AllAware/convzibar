...
export const checkPermissionBatchObjects = query({
    ...
    handler: async (ctx, args) => {
        return fetchEffectiveForward(ctx, {
            ...
            subjects: [args.subject],
            relations: args.relations,
            objectPoints: args.candidateObjectIds.map((id) => buildScopeKey(args.objectType, id)),
        });
    },
});
/**
...
export const checkPermissionBatchSubjects = query({
    ...
    handler: async (ctx, args) => {
        return fetchEffectiveReverse(ctx, {
            ...
            objects: [args.object],
            relations: args.relations,
            subjectPoints: args.candidateSubjectIds.map((id) => buildScopeKey(args.subjectType, id)),
        });
    },
});
/**
